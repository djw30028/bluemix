...
4. stop/delete if any: docker stop ab638e8ba614, docker rm ab638e8ba614
4. Build docker image: mvn clean package docker:build
5. Deploy image locally: docker run -p 8080:8080 -t michael/spring-boot-simple
